...
const faqSchema = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'How much does it cost to replace a drainfield?', acceptedAnswer: { '@type': 'Answer', text: 'A conventional drainfield replacement costs $5,000 to $15,000. A mound system replacement costs $10,000 to $20,000. The exact cost depends on field size, soil conditions, drainfield type, labor rates, and permitting requirements in your area.' } },
    { '@type': 'Question', name: 'How long does a drainfield last?', acceptedAnswer: { '@type': 'Answer', text: 'A well-maintained drainfield typically lasts 15 to 30 years. The biggest factor in lifespan is whether solids were kept out of the drainfield through regular tank pumping. Drainfields that receive solids from neglected tanks can fail in under 10 years.' } },
    { '@type': 'Question', name: 'Can a failed drainfield be repaired instead of replaced?', acceptedAnswer: { '@type': 'Answer', text: 'Sometimes. Rejuvenation techniques (soil aeration, hydro-jetting, bio-remediation) cost $1,000 to $5,000 and can restore a struggling drainfield if caught early. However, if the field has completely failed (standing water, sewage surfacing), rejuvenation rarely works and full replacement is necessary.' } },
    { '@type': 'Question', name: 'Does insurance cover drainfield replacement?', acceptedAnswer: { '@type': 'Answer', text: 'Almost never. Standard homeowner policies exclude drainfield failure because it is considered a maintenance issue. Insurance only covers damage from sudden covered perils like fire or fallen trees, which rarely affect drainfields. Drainfield replacement is virtually always an out-of-pocket expense.' } },
    { '@type': 'Question', name: 'How long does drainfield replacement take?', acceptedAnswer: { '@type': 'Answer', text: 'One to three weeks from excavation to completion for a conventional system. Permitting can add one to six weeks before work begins. Mound systems and engineered alternatives may take longer due to additional construction complexity.' } },
    { '@type': 'Question', name: 'What causes drainfield failure?', acceptedAnswer: { '@type': 'Answer', text: 'The most common cause is solids escaping from an unpumped septic tank and clogging the soil. Other causes include hydraulic overloading (too much water), soil compaction from vehicles or structures, tree root intrusion, and natural aging of the soil absorption capacity over 15 to 30 years.' } },
  ],
}
        ...
        <div className='mb-16'>
          ...
          <div className='space-y-6'>
            <div className='border-b border-slate-200 pb-4'>
              ...
              <p className='text-slate-700 text-sm'>A conventional drainfield replacement costs $5,000 to $15,000. A mound system replacement costs $10,000 to $20,000. The exact cost depends on field size, soil conditions, drainfield type, labor rates, and permitting requirements in your area.</p>
            </div>
            <div className='border-b border-slate-200 pb-4'>
              <h3 className='text-base font-bold text-slate-900 mb-2'>How long does a drainfield last?</h3>
              <p className='text-slate-700 text-sm'>A well-maintained drainfield typically lasts 15 to 30 years. The biggest factor in lifespan is whether solids were kept out of the drainfield through regular tank pumping. Drainfields that receive solids from neglected tanks can fail in under 10 years.</p>
            </div>
            <div className='border-b border-slate-200 pb-4'>
              <h3 className='text-base font-bold text-slate-900 mb-2'>Can a failed drainfield be repaired instead of replaced?</h3>
              <p className='text-slate-700 text-sm'>Sometimes. Rejuvenation techniques (soil aeration, hydro-jetting, bio-remediation) cost $1,000 to $5,000 and can restore a struggling drainfield if caught early. However, if the field has completely failed (standing water, sewage surfacing), rejuvenation rarely works and full replacement is necessary.</p>
            </div>
            <div className='border-b border-slate-200 pb-4'>
              <h3 className='text-base font-bold text-slate-900 mb-2'>Does insurance cover drainfield replacement?</h3>
              <p className='text-slate-700 text-sm'>Almost never. Standard homeowner policies exclude drainfield failure because it&apos;s considered a maintenance issue. Insurance only covers damage from sudden covered perils like fire or fallen trees, which rarely affect drainfields. Drainfield replacement is virtually always an out-of-pocket expense.</p>
            </div>
            <div className='border-b border-slate-200 pb-4'>
              <h3 className='text-base font-bold text-slate-900 mb-2'>How long does drainfield replacement take?</h3>
              <p className='text-slate-700 text-sm'>One to three weeks from excavation to completion for a conventional system. Permitting can add one to six weeks before work begins. Mound systems and engineered alternatives may take longer due to additional construction complexity.</p>
            </div>
            <div className='border-b border-slate-200 pb-4'>
              <h3 className='text-base font-bold text-slate-900 mb-2'>What causes drainfield failure?</h3>
              <p className='text-slate-700 text-sm'>The most common cause is solids escaping from an unpumped septic tank and clogging the soil. Other causes include hydraulic overloading (too much water), soil compaction from vehicles or structures, tree root intrusion, and natural aging of the soil&apos;s absorption capacity over 15 to 30 years.</p>
            </div>
          </div>
        </div>
        <div className='mb-16'>
