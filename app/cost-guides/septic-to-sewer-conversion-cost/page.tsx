  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'A septic to sewer conversion costs $5,000 to $15,000 for a typical residential conversion in 2026. The national average is $7,000 to $10,000. The total includes the sewer connection fee, sewer line installation, septic tank decommissioning, permits, and landscaping restoration.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Converting makes financial sense when your drainfield has failed or is failing, your municipality mandates conversion, you are selling in a market where buyers prefer sewer, your system is at end of life, or environmental regulations require expensive upgrades. If your septic system is healthy with 10 or more years of life remaining, staying on septic is usually cheaper over 20 years.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'A straightforward septic to sewer conversion takes 1 to 3 days for the actual installation work. The full process including permits, scheduling, and inspections typically takes 2 to 6 weeks from start to finish.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. Florida counties near the Indian River Lagoon offer 50 to 85 percent coverage. The Southern Nevada Water Authority covers up to 85 percent with a $40,000 maximum. Chesapeake Bay watershed states offer multiple programs. USDA Rural Development provides low-interest loans. State Clean Water Revolving Funds may also help.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'It depends on your municipality. Some areas require connection within a certain timeframe once sewer lines are available within a specified distance of your property. Others make it voluntary. Contact your local water and sewer authority for the specific rules in your area.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Your old septic tank must be properly decommissioned. This involves pumping out all remaining waste, collapsing or cutting holes in the tank top, filling the tank with sand, gravel, or concrete, and capping all inlet and outlet pipes. The municipality inspects the decommissioning. Never leave a septic tank empty and buried.',
      },
    },
  ],
}
        ...
        <div className="mb-16">
          ...
          <div className="space-y-3">
            ...
            <details className="border border-slate-200 rounded-lg group">
              ...
              <div className="px-4 pb-4 text-slate-600 text-sm">Converting makes financial sense when your drainfield has failed, your municipality mandates conversion, you are selling in a market where buyers prefer sewer, your system is at end of life, or environmental regulations require expensive upgrades. If your septic system is healthy with 10+ years of life remaining, staying on septic is usually cheaper over 20 years because sewer bills add $7,200 to $24,000 over two decades.</div>
            </details>
            <details className="border border-slate-200 rounded-lg group">
              ...
              <div className="px-4 pb-4 text-slate-600 text-sm">The actual installation work takes 1 to 3 days for a straightforward conversion. The full process including permits, scheduling, and inspections typically takes 2 to 6 weeks from start to finish.</div>
            </details>
            <details className="border border-slate-200 rounded-lg group">
            ...
            <details className="border border-slate-200 rounded-lg group">
              ...
              <div className="px-4 pb-4 text-slate-600 text-sm">It depends on your municipality. Some areas require connection within a set timeframe once sewer lines are available within a specified distance. Others make it voluntary. Contact your local water and sewer authority for the rules in your area.</div>
            </details>
            <details className="border border-slate-200 rounded-lg group">
              ...
              <div className="px-4 pb-4 text-slate-600 text-sm">The tank must be properly decommissioned: pump out all remaining waste, collapse or cut holes in the tank top to prevent future collapse, fill with sand, gravel, or concrete, and cap all inlet and outlet pipes. The municipality inspects the decommissioning. Never leave a septic tank empty and buried as it can collapse and create a sinkhole hazard.</div>
            </details>
          </div>
        </div>
