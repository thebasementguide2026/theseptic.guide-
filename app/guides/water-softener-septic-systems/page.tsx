    ...
    <>
      ...
      <article className='max-w-4xl mx-auto px-4 py-12'>
        ...
        <div className='mt-16'>
          ...
          <div className='grid md:grid-cols-2 gap-6 mb-10'>
            <a href='https://well.guide/guides/hard-water-well' target='_blank' rel='noopener noreferrer' className='block p-4 rounded-lg border-l-4 hover:shadow-md transition-shadow' style={{ borderLeftColor: '#1D9E75', borderTop: '1px solid #E8E4DE', borderRight: '1px solid #E8E4DE', borderBottom: '1px solid #E8E4DE' }}>
