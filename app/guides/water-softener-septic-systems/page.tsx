    ...
    <>
      ...
      <article className='max-w-4xl mx-auto px-4 py-12'>
        ...
        <div className='mb-16'>
          ...
          <p className='text-slate-700 leading-relaxed mb-4 text-sm'>For homeowners on a private well dealing with hardness, see our complete guide on <a href='/guides/hard-water-septic-system' className='underline' style={{ color: '#1D9E75' }}>how hard water affects your septic system</a> for the specific softener sizing, salt type, and regeneration scheduling practices that protect both your water quality and your septic system.</p>
        </div>
        ...
        <div className='mt-16'>
          ...
          <h3 className='text-sm font-semibold text-slate-500 uppercase tracking-wide mb-3'>Also on <span style={{ color: '#1D9E75' }}>The Well Guide</span></h3>
          <div className='grid md:grid-cols-2 gap-6 mb-10'>
            <a href='https://www.thewell.guide/guides/hard-water-well' target='_blank' rel='noopener noreferrer' className='block p-4 rounded-lg border-l-4 hover:shadow-md transition-shadow' style={{ borderLeftColor: '#1D9E75', borderTop: '1px solid #E8E4DE', borderRight: '1px solid #E8E4DE', borderBottom: '1px solid #E8E4DE' }}>
              <h4 className='font-bold text-slate-900 mb-1 text-sm'>Hard Water in Wells: Treatment, Softeners, and the Iron Co-Occurrence Problem</h4>
              <p className='text-slate-600 text-xs'>The well-side companion to this guide — covers hard water testing, treatment options, and the iron co-occurrence problem that affects softener performance and septic health.</p>
