    ...
    <>
      ...
      <article className="py-12">
        <div className="container-custom max-w-3xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-10">
            <a href="https://www.thewell.guide/problems/well-running-dry" target="_blank" rel="noopener noreferrer" className="block p-4 rounded-lg border-l-4 hover:shadow-md transition-shadow bg-white" style={{ borderLeftColor: '#1D9E75', borderTop: '1px solid #E8E4DE', borderRight: '1px solid #E8E4DE', borderBottom: '1px solid #E8E4DE' }}>
            ...
            <a href="https://www.thewell.guide/guides/complete-well-guide" target="_blank" rel="noopener noreferrer" className="block p-4 rounded-lg border-l-4 hover:shadow-md transition-shadow bg-white" style={{ borderLeftColor: '#1D9E75', borderTop: '1px solid #E8E4DE', borderRight: '1px solid #E8E4DE', borderBottom: '1px solid #E8E4DE' }}>
