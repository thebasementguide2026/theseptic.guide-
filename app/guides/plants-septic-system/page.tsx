      ...
      <article className='max-w-4xl mx-auto px-4 py-12'>
        ...
        <section className='mb-16'>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
            <a href='https://www.thewell.guide/guides/well-water-treatment-options' target='_blank' rel='noopener noreferrer' className='bg-white rounded-xl p-5 shadow-sm border-l-4 hover:shadow-md transition-shadow' style={{ borderLeftColor: '#1D9E75', borderTop: '1px solid #E8E4DE', borderRight: '1px solid #E8E4DE', borderBottom: '1px solid #E8E4DE' }}>
