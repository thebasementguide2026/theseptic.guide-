...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'How can I contact The Septic Guide?',
      acceptedAnswer: {
        '@type': 'Answer',
        ...
        <section className="container mx-auto px-4 max-w-2xl py-16">
          ...
          <div className="mt-12 pt-8 border-t border-slate-200">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold text-slate-900">How can I contact The Septic Guide?</h3>
