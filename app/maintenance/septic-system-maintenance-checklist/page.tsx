      ...
      <article className="max-w-4xl mx-auto px-4 py-16">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4"><h3 className="text-amber-600 font-semibold mb-1">Effluent Filter</h3><p className="text-gray-500 text-sm">An effluent filter is a screen installed at the tank outlet that catches suspended solids in the effluent before they reach the drainfield, providing an additional layer of protection against clogs and premature drainfield failure. Effluent filters need to be cleaned every 6 to 12 months because a clogged filter restricts flow and can cause backups inside the house. Cleaning the filter is one of the few septic maintenance tasks that is genuinely DIY-friendly -- pull it from the outlet baffle, hose it off over the open tank so debris falls back in, and reinsert it.</p></div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4"><h3 className="text-amber-600 font-semibold mb-1">Hydraulic Overload</h3><p className="text-gray-500 text-sm">Hydraulic overload occurs when more water enters the septic system than the drainfield can absorb, overwhelming the soil's capacity to filter effluent and causing it to surface in the yard or back up into the house. Common causes include concentrating large amounts of laundry into a single day, hosting guests who significantly increase water usage, roof gutters or sump pump discharge draining toward the drainfield, and heavy rain saturating the soil around the system. Spreading water use across the week, fixing leaky fixtures, and diverting surface water away from the drainfield are the most effective ways to prevent hydraulic overload. See our septic overflow after rain guide for more detail.</p></div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4"><h3 className="text-amber-600 font-semibold mb-1">Frost Heaving</h3><p className="text-gray-500 text-sm">Frost heaving is the ground movement caused by freezing and thawing cycles that can shift tank lids, crack risers, displace pipe connections, and damage other buried septic components over winter. It is most common in climates with hard freezes and wet soil conditions, where water in the ground expands as it freezes and pushes upward against buried structures. Checking all lids, risers, and inspection ports each spring for frost damage is an important part of the seasonal maintenance checklist because cracked seals let surface water infiltrate the tank, adding unnecessary volume the system was not designed to handle.</p></div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4"><h3 className="text-amber-600 font-semibold mb-1">Biomat</h3><p className="text-gray-500 text-sm">A biomat is a dense bacterial layer that forms on the surfaces of drainfield trenches as a natural byproduct of effluent filtration, and in thin layers it is a normal and beneficial part of the treatment process. Problems arise when the biomat grows too thick, typically from overloading the system with solids from a neglected tank or excessive water use, blocking the soil's ability to absorb effluent and causing it to surface in the yard. Keeping the tank pumped on schedule is the most effective prevention since the primary cause is solids escaping from an overfull tank into the drainfield. See our drainfield failing guide for warning signs.</p></div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4"><h3 className="text-amber-600 font-semibold mb-1">Winterization</h3><p className="text-gray-500 text-sm">Winterization is the process of preparing a septic system for extended vacancy during cold months, and it typically involves pumping the tank, draining exposed pipes, insulating vulnerable components, and shutting off water supply to the property. A system left with water sitting in pipes and fixtures during a hard freeze can experience burst pipes, cracked fittings, and damaged tank components that are expensive to repair when the property is reopened. Winterization should always be performed by a licensed septic professional because improper winterization can leave water trapped in locations that freeze and cause damage, defeating the purpose of the process entirely.</p></div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4"><h3 className="text-amber-600 font-semibold mb-1">Sludge Level</h3><p className="text-gray-500 text-sm">Sludge level refers to the depth of settled solid waste at the bottom of the septic tank, and it is the primary measurement used to determine whether pumping is needed. When the sludge layer reaches one-third of the tank's total depth, typically measured with a sludge judge tool during a professional inspection, pumping is overdue regardless of how recently the last service was performed. Monitoring sludge levels at every inspection visit rather than pumping on a fixed calendar schedule is the most accurate way to match your pumping frequency to your household's actual waste output. See our how often to pump your septic tank guide for a full schedule by tank size and household size.</p></div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4"><h3 className="text-amber-600 font-semibold mb-1">Root Barrier</h3><p className="text-gray-500 text-sm">A root barrier is a physical or chemical barrier installed between trees, shrubs, or other plants and septic system components to redirect root growth away from pipes, tank walls, and drainfield trenches. Tree roots are naturally drawn to the moisture and nutrients in septic systems and can infiltrate pipe joints, crack tank walls, and clog drainfield trenches, causing damage that is expensive to repair and entirely preventable with proper planting distances and barriers. As a general rule, no trees or large shrubs should be planted within 30 feet of any septic component, and existing trees near the system should be monitored annually for signs of root intrusion.</p></div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4"><h3 className="text-amber-600 font-semibold mb-1">Inspection Port</h3><p className="text-gray-500 text-sm">An inspection port is a small capped pipe extending from the septic tank or drainfield distribution box up to near ground level, allowing a technician to perform quick visual checks of water levels and system conditions without fully excavating or opening the main tank lids. Inspection ports make routine monitoring significantly faster and less expensive than full excavation, and they are a standard feature on well-maintained systems. If your system does not have inspection ports or risers, consider having them installed during your next pump-out since the one-time cost eliminates the $50 to $200 digging fee at every future service visit. See our best septic tank risers guide for top-rated options.</p></div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4"><h3 className="text-amber-600 font-semibold mb-1">Aerator</h3><p className="text-gray-500 text-sm">An aerator is the mechanical component in an aerobic treatment unit that injects oxygen into the treatment tank, supporting aerobic bacteria that break down waste much more efficiently than the anaerobic bacteria in a conventional septic tank. Aerators have a typical lifespan of 3 to 5 years and require annual professional inspection to verify they are functioning correctly, since a failed aerator can cause an ATU to stop treating wastewater properly without any visible external warning signs. Annual inspection of the aerator is typically required as a condition of the ATU operating permit in most states. See our aerobic vs anaerobic septic systems comparison for a full breakdown of ATU maintenance requirements.</p></div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4"><h3 className="text-amber-600 font-semibold mb-1">Distribution Box (D-box)</h3><p className="text-gray-500 text-sm">A distribution box is a small concrete or plastic underground box that receives clarified effluent from the septic tank outlet and divides it equally among the drainfield pipe lines to ensure even distribution across the entire drainfield area. An uneven or clogged D-box causes some drainfield sections to receive too much effluent while others receive too little, accelerating failure in the overloaded sections and leaving other sections underused. D-box condition should be checked during every professional inspection. See our septic inspection cost guide for what a thorough inspection should include.</p></div>
          </div>
        </section>
