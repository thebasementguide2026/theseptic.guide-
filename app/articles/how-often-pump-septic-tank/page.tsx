  ...
  return (
    <div>
      ...
      <article className='max-w-4xl mx-auto px-4 py-12'>
        ...
        {/* Maintenance Schedule */}         <div className='mb-16'>           <div className='flex items-center space-x-3 mb-4'>             <span className='text-amber-700 font-bold tracking-[0.3em] text-xs uppercase'>Maintenance</span>             <div className='flex-1 h-px bg-slate-200'></div>           </div>           <h2 className='text-2xl font-bold text-slate-900 mb-4'>Complete Septic System Maintenance Schedule</h2>           <p className='text-slate-700 leading-relaxed mb-6 text-sm'>Pumping is the most important maintenance task but not the only one. Use this schedule to keep every component of your system healthy year-round.</p>           <div className='overflow-x-auto my-6'>             <table className='w-full text-xs border-collapse'>               <thead>                 <tr className='bg-slate-900 text-white'>                   <th className='p-2 text-left font-semibold'>Task</th>                   <th className='p-2 text-left font-semibold'>Frequency</th>                   <th className='p-2 text-left font-semibold'>Cost</th>                   <th className='p-2 text-left font-semibold'>Why It Matters</th>                 </tr>               </thead>               <tbody>                 <tr className='border-b border-slate-200'><td className='p-2 text-slate-900'>Pump the septic tank</td><td className='p-2 text-slate-700'>Every 2 to 5 years (see schedule table above)</td><td className='p-2 text-slate-700'>$300 &ndash; $600</td><td className='p-2 text-slate-700'>Removes sludge and scum before they escape to the drainfield</td></tr>                 <tr className='border-b border-slate-200 bg-slate-50'><td className='p-2 text-slate-900'>Clean or replace the effluent filter</td><td className='p-2 text-slate-700'>Every 1 to 2 years, or at every pump-out</td><td className='p-2 text-slate-700'>$0 &ndash; $200</td><td className='p-2 text-slate-700'>Prevents solids from reaching the drainfield between pump-outs</td></tr>                 <tr className='border-b border-slate-200'><td className='p-2 text-slate-900'>Inspect inlet and outlet baffles</td><td className='p-2 text-slate-700'>At every pump-out</td><td className='p-2 text-slate-700'>Included in pump-out</td><td className='p-2 text-slate-700'>Cracked or missing baffles allow solids to exit the tank</td></tr>                 <tr className='border-b border-slate-200 bg-slate-50'><td className='p-2 text-slate-900'>Check tank lid and riser seals</td><td className='p-2 text-slate-700'>Annually</td><td className='p-2 text-slate-700'>$10 &ndash; $300</td><td className='p-2 text-slate-700'>Damaged seals allow gases to escape and groundwater to enter</td></tr>                 <tr className='border-b border-slate-200'><td className='p-2 text-slate-900'>Inspect distribution box</td><td className='p-2 text-slate-700'>Every 3 to 5 years</td><td className='p-2 text-slate-700'>$100 &ndash; $500</td><td className='p-2 text-slate-700'>An unlevel D-box overloads one drainfield section and causes premature failure</td></tr>                 <tr className='border-b border-slate-200 bg-slate-50'><td className='p-2 text-slate-900'>Walk the drainfield area</td><td className='p-2 text-slate-700'>Every spring and fall</td><td className='p-2 text-slate-700'>Free</td><td className='p-2 text-slate-700'>Check for soggy soil, standing water, or unusually green grass indicating early failure</td></tr>                 <tr className='border-b border-slate-200'><td className='p-2 text-slate-900'>Divert surface water away from drainfield</td><td className='p-2 text-slate-700'>Ongoing</td><td className='p-2 text-slate-700'>$0 &ndash; $500</td><td className='p-2 text-slate-700'>Excess water hydraulically overloads the drainfield and reduces absorption capacity</td></tr>                 <tr className='border-b border-slate-200 bg-slate-50'><td className='p-2 text-slate-900'>Fix leaky toilets and faucets</td><td className='p-2 text-slate-700'>As soon as discovered</td><td className='p-2 text-slate-700'>$50 &ndash; $200</td><td className='p-2 text-slate-700'>A single running toilet adds 200 gallons per day, tripling the hydraulic load</td></tr>                 <tr className='border-b border-slate-200'><td className='p-2 text-slate-900'>Avoid chemical drain cleaners</td><td className='p-2 text-slate-700'>Always</td><td className='p-2 text-slate-700'>$0</td><td className='p-2 text-slate-700'>Caustic chemicals kill anaerobic bacteria and accelerate sludge buildup</td></tr>                 <tr className='border-b border-slate-200 bg-slate-50'><td className='p-2 text-slate-900'>Keep vehicles off drainfield</td><td className='p-2 text-slate-700'>Always</td><td className='p-2 text-slate-700'>$0</td><td className='p-2 text-slate-700'>Vehicle traffic permanently compacts soil and crushes drainfield pipes</td></tr>                 <tr className='border-b border-slate-200'><td className='p-2 text-slate-900'>Pump aerobic system and inspect mechanical components</td><td className='p-2 text-slate-700'>Annually</td><td className='p-2 text-slate-700'>$150 &ndash; $300</td><td className='p-2 text-slate-700'>Aerobic units have pumps, aerators, and float switches that require regular checks</td></tr>                 <tr className='border-b border-slate-200 bg-slate-50'><td className='p-2 text-slate-900'>Full professional system inspection</td><td className='p-2 text-slate-700'>Every 1 to 3 years</td><td className='p-2 text-slate-700'>$100 &ndash; $300</td><td className='p-2 text-slate-700'>Catches developing problems before they become expensive failures</td></tr>               </tbody>             </table>           </div>         </div>          {/* Glossary */}
        <div className='mb-16'>
          <div className='flex items-center space-x-3 mb-4'>
