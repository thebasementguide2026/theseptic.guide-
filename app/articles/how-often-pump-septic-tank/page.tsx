...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'The clearest signs are slow drains throughout the house (not just one fixture), sewage odors in the yard near the tank or drainfield, standing water or soggy soil over the drainfield, and sewage backing up into the lowest drains in the house. Any of these warrants an immediate service call.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Significantly. A garbage disposal sends food waste into the tank that bacteria break down more slowly than human waste, increasing the sludge accumulation rate. Homes with garbage disposals should pump 30 to 50 percent more often than the standard schedule. Some state guidelines recommend annual pumping for homes with garbage disposals regardless of tank size.',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Late summer or fall is ideal in most climates. The ground is accessible, the water table is typically at its lowest, and septic companies tend to have more availability than in spring. Avoid pumping during or immediately after heavy rain or flooding, as removing liquid from the tank when the surrounding soil is saturated can cause the tank to shift or float.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'No. The EPA does not recommend septic additives, and most independent research supports that position. Your tank already contains the bacteria it needs to function. Additives that claim to eliminate pumping can actually harm your system by breaking up the sludge layer and allowing solids to flow into the drainfield.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'The national average is $300 to $600 for a standard residential tank. Cost varies by tank size, region, and accessibility.',
      },
    },
  ],
}
        ...
        <div className='mb-16'>
          ...
          <div className='space-y-3'>
            <details className='border border-slate-200 rounded-lg group'>
              ...
              <div className='px-4 pb-4 text-slate-600 text-sm'>With a 1,000-gallon tank (the most common size for a three-bedroom home), approximately every two and a half years. With a 1,500-gallon tank, approximately every three and a half years. These estimates assume no garbage disposal and moderate water use. If you use a garbage disposal regularly, reduce the interval by 30 to 50 percent.</div>
            </details>
            <details className='border border-slate-200 rounded-lg group'>
              ...
              <div className='px-4 pb-4 text-slate-600 text-sm'>The clearest signs are slow drains throughout the house (not just one fixture), sewage odors in the yard near the tank or drainfield, standing water or soggy soil over the drainfield, and sewage backing up into the lowest drains in the house. Any of these warrants an immediate service call.</div>
            </details>
            <details className='border border-slate-200 rounded-lg group'>
              ...
              <div className='px-4 pb-4 text-slate-600 text-sm'>Significantly. A garbage disposal sends food waste into the tank that bacteria break down more slowly than human waste, increasing the sludge accumulation rate. Homes with garbage disposals should pump 30 to 50 percent more often than the standard schedule.</div>
            </details>
            <details className='border border-slate-200 rounded-lg group'>
              ...
              <div className='px-4 pb-4 text-slate-600 text-sm'>Not unless your specific situation requires it (small tank, large household, garbage disposal, or aerobic system). For most households, annual pumping is more frequent than necessary and wastes money. The most accurate approach is to have sludge and scum levels measured during an inspection and pump only when levels reach the one-third threshold.</div>
            </details>
            <details className='border border-slate-200 rounded-lg group'>
              ...
              <div className='px-4 pb-4 text-slate-600 text-sm'>Late summer or fall is ideal in most climates. The ground is accessible, the water table is typically at its lowest, and septic companies tend to have more availability than in spring. Avoid pumping during or immediately after heavy rain or flooding.</div>
            </details>
            <details className='border border-slate-200 rounded-lg group'>
              ...
              <div className='px-4 pb-4 text-slate-600 text-sm'>No. The <a href='https://www.epa.gov/septic/how-care-your-septic-system' target='_blank' rel='noopener noreferrer' className='text-amber-700 underline hover:text-amber-800'>EPA</a> does not recommend septic additives. Your tank already contains the bacteria it needs to function. Additives that claim to eliminate pumping can actually harm your system by breaking up the sludge layer and allowing solids to flow into the drainfield.</div>
            </details>
            <details className='border border-slate-200 rounded-lg group'>
              ...
              <div className='px-4 pb-4 text-slate-600 text-sm'>The national average is $300 to $600 for a standard residential tank. Cost varies by tank size, region, and accessibility. For a detailed breakdown, see our <Link href='/articles/septic-tank-pumping-cost' className='text-amber-700 underline hover:text-amber-800'>septic tank pumping cost guide</Link>.</div>
            </details>
          </div>
        </div>
