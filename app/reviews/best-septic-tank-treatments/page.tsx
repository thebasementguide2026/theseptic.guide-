  ...
  return (
    <>
      ...
      <article className='max-w-4xl mx-auto px-4 py-12'>
        ...
        {/* Which Treatment Is Right */}         <div className='mb-16'>           <div className='flex items-center space-x-3 mb-4'>             <span className='text-amber-700 font-bold tracking-[0.3em] text-xs uppercase'>Recommendation</span>             <div className='flex-1 h-px bg-slate-200'></div>           </div>           <h2 className='text-2xl font-bold text-slate-900 mb-6'>Which Septic Treatment Is Right for Your Situation?</h2>           <div className='overflow-x-auto mb-4'>             <table className='w-full text-sm border-collapse'>               <thead>                 <tr className='bg-slate-100'>                   <th className='text-left p-3 font-bold text-slate-900 border border-slate-200'>Your Situation</th>                   <th className='text-left p-3 font-bold text-slate-900 border border-slate-200'>Our Pick</th>                   <th className='text-left p-3 font-bold text-slate-900 border border-slate-200'>Why</th>                 </tr>               </thead>               <tbody>                 <tr className='hover:bg-slate-50'>                   <td className='p-3 border border-slate-200 font-semibold text-slate-900'>General monthly maintenance</td>                   <td className='p-3 border border-slate-200 text-slate-600'>Rid-X Septic Treatment</td>                   <td className='p-3 border border-slate-200 text-slate-600'>Best all-around formula with 4 enzymes, widely available, proven track record</td>                 </tr>                 <tr className='hover:bg-slate-50'>                   <td className='p-3 border border-slate-200 font-semibold text-slate-900'>Budget is the priority</td>                   <td className='p-3 border border-slate-200 text-slate-600'>Green Gobbler Septic Saver</td>                   <td className='p-3 border border-slate-200 text-slate-600'>Lowest annual cost, pod format is foolproof</td>                 </tr>                 <tr className='hover:bg-slate-50'>                   <td className='p-3 border border-slate-200 font-semibold text-slate-900'>Neglected or struggling system</td>                   <td className='p-3 border border-slate-200 text-slate-600'>Bio-Clean Drain Septic Bacteria</td>                   <td className='p-3 border border-slate-200 text-slate-600'>Highest bacteria concentration, used by septic professionals for restoration</td>                 </tr>                 <tr className='hover:bg-slate-50'>                   <td className='p-3 border border-slate-200 font-semibold text-slate-900'>Want a full year supply in one purchase</td>                   <td className='p-3 border border-slate-200 text-slate-600'>Cabin Obsession Septic Treatment</td>                   <td className='p-3 border border-slate-200 text-slate-600'>12-month supply, buy once per year</td>                 </tr>                 <tr className='hover:bg-slate-50'>                   <td className='p-3 border border-slate-200 font-semibold text-slate-900'>Just had the tank pumped</td>                   <td className='p-3 border border-slate-200 text-slate-600'>Walex Bio-Active Septic Treatment</td>                   <td className='p-3 border border-slate-200 text-slate-600'>Specifically formulated to rebuild bacterial colony after pumping</td>                 </tr>                 <tr className='hover:bg-slate-50'>                   <td className='p-3 border border-slate-200 font-semibold text-slate-900'>Vacation home or seasonal property</td>                   <td className='p-3 border border-slate-200 text-slate-600'>Cabin Obsession Septic Treatment</td>                   <td className='p-3 border border-slate-200 text-slate-600'>Full year supply stays on-site, dose before and after idle periods</td>                 </tr>                 <tr className='hover:bg-slate-50'>                   <td className='p-3 border border-slate-200 font-semibold text-slate-900'>Heavy garbage disposal use</td>                   <td className='p-3 border border-slate-200 text-slate-600'>Bio-Clean Drain Septic Bacteria</td>                   <td className='p-3 border border-slate-200 text-slate-600'>Strongest formula for breaking down food waste</td>                 </tr>               </tbody>             </table>           </div>         </div>          {/* When Treatments Help */}
        <div className='mb-16'>
          <div className='flex items-center space-x-3 mb-4'>
